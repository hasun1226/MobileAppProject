...
####Decisions did not turn out as well as you hoped:####
 ...
 3. The method of coordinating team members that we decided to use is slightly inconsistent. We used only slack as to coordinate any team meatings. This lead to the inability to have a video making session. As a result, the videographers are reduced down to two members from initial four members but the members still had to work individually.
